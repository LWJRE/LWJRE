package io.github.hexagonnico.core.utils;

import io.github.hexagonnico.core.util.ReflectionException;
import io.github.hexagonnico.core.util.ReflectionUtils;
...
public class TestReflectionUtils {
    ...
    public void testNewInstance() {
        var instance = ReflectionUtils.newInstance("io.github.hexagonnico.core.utils.TestReflectionUtils$MockClass");
    ...
    public void testNewInstanceWithNoPublicNoArgsConstructor() {
        Assertions.assertThrows(ReflectionException.class, () -> ReflectionUtils.newInstance("io.github.hexagonnico.core.utils.TestReflectionUtils$MockClassWithConstructor"));
    }
    ...
    public void testNewInstanceWithException() {
        Assertions.assertThrows(ReflectionException.class, () -> ReflectionUtils.newInstance("io.github.hexagonnico.core.utils.TestReflectionUtils$MockClassWithException"));
    }

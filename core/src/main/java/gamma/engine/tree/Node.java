...
public class Node {
	...
	/**
	 * Called every frame when this node is in the scene tree.
	 * Node classes must override this to provide their functionalities.
	 *
	...
	/**
	 * Called when the node is added to the scene tree with {@link Node#addChild(Node)} or {@link SceneTree#changeScene(Node)}..
	 ...
	 * Calls {@link Node#enter()} on the added node if this node is inside the scene tree.
	...
	/**
	 * Called when the node exits to the scene tree after {@link Node#removeChild(Node)} or {@link SceneTree#changeScene(Node)} are called.
	 ...
	 * Calls {@link Node#exit()} on the removed node if this node is inside the scene tree.
	...
	/**
	 * Checks if this node is inside the scene tree, i.e., if {@link Node#enter()} has been called.
	 *
	 ...
	 */
	private enum State {
		/** The node has been added to the scene tree */
		INSIDE_TREE,
		/** The node is not in the scene tree */
		OUTSIDE_TREE,
		/** The node has been queued to be removed from the scene tree */
		REMOVING
	}
}

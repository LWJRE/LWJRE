...
public final class NodeResource {
	...
	/** Fully qualified class name of the node that this resource represents. By default {@code "gamma.engine.tree.Node"}. */
	public String type;
	...
	public Node instantiate() {
		try {
			...
			if(this.override != null && !this.override.isEmpty()) {
				...
				node = (Node) Reflection.instantiate("gamma.engine.tree.Node");
			} else {

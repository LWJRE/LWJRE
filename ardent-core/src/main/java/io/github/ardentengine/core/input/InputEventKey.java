...
public record InputEventKey(int keyCode, int modifiers, boolean isPressed, boolean isEcho) implements InputEventWithModifiers {
    ...
    public InputEventKey(int keyCode, boolean isPressed, boolean isEcho) {
        this(keyCode, 0, isPressed, isEcho);
    }

    public InputEventKey(int keyCode, int modifiers, boolean isPressed) {
        this(keyCode, modifiers, isPressed, false);
    }

    public InputEventKey(int keyCode, boolean isPressed) {
        this(keyCode, isPressed, false);
    }

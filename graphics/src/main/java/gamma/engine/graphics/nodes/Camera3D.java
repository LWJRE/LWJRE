...
import gamma.engine.core.tree.Node3D;
...
//		});
	...
	public Mat4f projectionMatrix() {
		...
		float aspect = ApplicationProperties.get("window/viewport/width", 16.0f) / ApplicationProperties.get("window/viewport/height", 9.0f);
		return new Mat4f(

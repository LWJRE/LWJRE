...
import io.github.lwjre.engine.resources.ShaderCompilationException;
...
public final class DebugRenderer {
	...
	static {
		try {
			String debugVertex = FileUtils.readResourceAsString("io/github/lwjre/engine/shaders/debug_vertex.glsl");
			String debugFragment = FileUtils.readResourceAsString("io/github/lwjre/engine/shaders/debug_fragment.glsl");
